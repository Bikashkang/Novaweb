...
export function IconStethoscope(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
			...
			<path d="M12 12a6 6 0 01-6 6H5a3 3 0 100 6h1a9 9 0 009-9" />
		</svg>
	);
}
...
export function IconPill(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
			<rect x="3" y="7" width="14" height="10" rx="5" />
			<path d="M7 7v10" />
		</svg>
	);
}
...
export function IconAmbulance(props: SVGProps<SVGSVGElement>) {
	return (
		<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" {...props}>
			<path d="M7 16H3v-5a2 2 0 012-2h5l3 3h6a2 2 0 012 2v2h-2" />
