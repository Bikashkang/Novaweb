...
exports.getVideoCallReadyTemplate = getVideoCallReadyTemplate;
function getVideoCallReadyTemplate(data) {
    const { patientName, doctorName, appointmentDate, appointmentTime, roomUrl, frontendUrl } = data;
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="background-color: #8b5cf6; padding: 30px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Video Call Ready</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #666666; font-size: 14px; line-height: 1.6; margin: 20px 0;">
                Click the button below to join your video consultation. Make sure you have a stable internet connection and your camera/microphone permissions enabled.
              </p>
              
              <div style="text-align: center; margin: 30px 0;">
                <a href="${roomUrl}" style="display: inline-block; background-color: #8b5cf6; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold;">
                  Join Video Call
                </a>
              </div>
              
              <p style="color: #666666; font-size: 12px; line-height: 1.6; margin: 20px 0 0 0;">
                Or visit: <a href="${roomUrl}" style="color: #2563eb;">${roomUrl}</a>
              </p>
            </td>
          </tr>
...
//# sourceMappingURL=video-call-ready.template.js.map