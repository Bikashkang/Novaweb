...
exports.getAppointmentCreatedTemplate = getAppointmentCreatedTemplate;
function getAppointmentCreatedTemplate(data) {
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
          ...
          <tr>
            <td style="background-color: #2563eb; padding: 30px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 24px;">Appointment Booked</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #666666; font-size: 14px; line-height: 1.6; margin: 20px 0 0 0;">
                Your appointment is pending confirmation from the doctor. You will receive an email once the doctor accepts your appointment.
              </p>
              
              <div style="text-align: center; margin: 30px 0;">
                <a href="${frontendUrl}/my/bookings" style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 6px; font-weight: bold;">
...
//# sourceMappingURL=appointment-created.template.js.map